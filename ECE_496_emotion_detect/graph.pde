...
void draw(){
 ...
 // for(int i=0; i<numOrgans; i++){
      ...
      pushMatrix();
          scale(0.35);
 myGraph.myPieChart[0].DrawBarGraph((float)amuse*6.35);
   myGraph.DrawCenter(0);
  ...
  /////////////////////////////////////
    ...
    pushMatrix();
      // scale(0.5);
    myGraph.myPieChart[1].DrawBarGraph((float)anger*6.35);
      myGraph.DrawCenter(1);
...
/////////////////////////////////////////////
      ...
      pushMatrix();
    myGraph.myPieChart[2].DrawBarGraph((float)awe*6.35);
      myGraph.DrawCenter(2);
...
/////////////////////////////////////
          pushMatrix();
    myGraph.myPieChart[3].DrawBarGraph((float)content*6.35);
      myGraph.DrawCenter(3);
...
/////////////////////////////////////////////////
  pushMatrix();
    myGraph.myPieChart[4].DrawBarGraph((float)disgust*6.35);
      myGraph.DrawCenter(4);
...
////////////////////////////////////////////////
  pushMatrix();
    myGraph.myPieChart[4].DrawBarGraph((float)excite*6.35);
      myGraph.DrawCenter(5);
...
/////////////////////////////////////////////////
      pushMatrix();
    myGraph.myPieChart[4].DrawBarGraph((float)fear*6.35);
      myGraph.DrawCenter(6);
...
/////////////////////////////////////////////////
  pushMatrix();
    myGraph.myPieChart[4].DrawBarGraph((float)sad*6.35);
      myGraph.DrawCenter(7);
...
public class Graph {
  ...
  public void DrawCenter(int yearIndex){
    ...
    // title
    textSize(24);
    text("Emotion Detection", width/2,height/2-36-18);
    text("ECE516 Final Design",width/2,height/2-36+18);
    ...
    switch(yearIndex){
      case 0:
        text(round((float)amuse*100)+"% Amusement",width/2,height/2+14);
        break;
      case 1:
        text(round((float)anger*100)+"% Anger",width/2,height/2+14);
        break; 
       case 2:
      text(round((float)awe*100)+"% Awe",width/2,height/2+14);
        break; 
        
       case 3:
        text(round((float)content*100)+"% Content",width/2,height/2+14);
        break;  
        case 4:
      text(round((float)disgust*100)+"% Disgust",width/2,height/2+14);
        break; 
       case 5:
      text(round((float)excite*100)+"% Excitement",width/2,height/2+14);
        break;  
        case 6:
        
      text(round((float)fear*100)+"% Fear",width/2,height/2+14);
        break;  
         case 7:
        
      text(round((float)sad*100)+"% Sad",width/2,height/2+14);
        break;  
