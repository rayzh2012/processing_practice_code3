    ...
    println(input[i][0]);
     ...
     //Send the array to MATLAB, transpose it, then retrieve it and convert it to a 2D double array
      MatlabTypeConverter processor = new MatlabTypeConverter(proxy);
       ...
       proxy.eval("array = b(array);");
    
       double[][] javaArray = processor.getNumericArray("array").getRealArray2D();
        System.out.println("Amusement: " + javaArray[0][0]*100 + 
        "Anger: "+ javaArray[1][0]*100 + "%" +
        "Awe: " + javaArray[2][0]*100 + "%"+
        "Content: " + javaArray[3][0]*100 + "%"+
        "Disgust: " + javaArray[4][0]*100 + "%"+
        "Excitement: " + javaArray[5][0]*100 + "%"+
        "Fear: " + javaArray[6][0]*100 + "%"+
        "Sad: " + javaArray[7][0]*100 + "%"
        //"Awe: " + javaArray[2][0]*100 + "%"+
         ...
         anger = javaArray[1][0];
         awe = javaArray[2][0];
         content = javaArray[3][0];
         disgust = javaArray[4][0];
         excite = javaArray[5][0];
         fear = javaArray[6][0];
         sad = javaArray[7][0];
