/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/183729*@* */
...
void draw(){
 ...
 myGraph.myPieChart[0].DrawBarGraph(k);
  ...
  /////////////////////////////////////
    ...
    pushMatrix();
      // scale(0.5);
    myGraph.myPieChart[1].DrawBarGraph(k);
...
/////////////////////////////////////////////
      ...
      pushMatrix();
    myGraph.myPieChart[2].DrawBarGraph(k);
...
/////////////////////////////////////
          pushMatrix();
    myGraph.myPieChart[3].DrawBarGraph(k);
...
/////////////////////////////////////////////////
  pushMatrix();
    myGraph.myPieChart[4].DrawBarGraph(k);
...
public class Graph {
  ...
  public void DrawCenter(int yearIndex){
    ...
    switch(yearIndex){
      case 0:
        text(round(k/6.35*100)+"% Amusement",width/2,height/2+14);
        break;
      case 1:
        text(round(k/6.35*100)+"% Anger",width/2,height/2+14);
        break; 
       case 2:
      text(round(k/6.35*100)+"% Awe",width/2,height/2+14);
        break; 
       case 3:
      text(round(k/6.35*100)+"% Disgust",width/2,height/2+14);
        break; 
       case 4:
      text(round(k/6.35*100)+"% Excitement",width/2,height/2+14);
        break;  
        case 5:
        
      text(round(k/6.35*100)+"% Fear",width/2,height/2+14);
        break;  
         case 6:
        
      text(round(k/6.35*100)+"% Sad",width/2,height/2+14);
        break;  
